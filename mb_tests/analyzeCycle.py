...
# THIS TEST GETS THE FINAL RESULTS TO SEND THEM TO PythonFiles/Scenes/ThermalTestFinalResultsScene.py
...
class Test():
    ...
    def __init__(self, conn_test, gui_cfg, sites=None, tester=None):
        ...
        # Load JSON file that matches site to test results
        #self.conn.send('Done.')
        #self.conn.send(the_json_contents)
        # the json should look like {site_name: {"passing state": state, "results": json_attachment}}
